...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "news" }, _attrs))} data-v-52c1bb23><h2 data-v-52c1bb23>\u041D\u043E\u0432\u043E\u0441\u0442\u0438</h2><!--[-->`);
      ...
      _push(`<!--]--><div class="more_news" data-v-52c1bb23>`);
      if (unref(hasNextPage)) {
        _push(`<button class="more_news__btn"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-52c1bb23>${ssrInterpolate(unref(loading) ? "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..." : "\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0435\u0449\u0451")}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
const allnews = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52c1bb23"]]);

export { allnews as default };
//# sourceMappingURL=allnews-BUKZ5JBi.mjs.map
