...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "information" }, _attrs))} data-v-3f1ef389><h1 data-v-3f1ef389>\u041F\u0440\u0438\u0451\u043C \u0432 1 \u043A\u043B\u0430\u0441\u0441</h1><!--[-->`);
      ssrRenderList(unref(source), (doc) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p class="inline text-blue-600 hover:underline" data-v-3f1ef389${_scopeId}>${ssrInterpolate(doc.title)}</p>`);
            } else {
              return [
      ...
      _push(`<!--]--><div class="more_documents-btn" data-v-3f1ef389>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/receiving_to_1_class.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const receiving_to_1_class = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3f1ef389"]]);

export { receiving_to_1_class as default };
//# sourceMappingURL=receiving_to_1_class-BIAeR-KJ.mjs.map
