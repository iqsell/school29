...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const loadNews = async (url = `${apiUrl}/news/?page_size=3`) => {
      try {
        loading.value = true;
        const { data, error } = await useFetch(url, "$ZlSgwL-Pkm");
        if (error.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "news" }, _attrs))} data-v-7bfd41f8><h2 data-v-7bfd41f8>\u041D\u043E\u0432\u043E\u0441\u0442\u0438</h2><!--[-->`);
      ...
      _push(`<!--]--><div class="more_news" data-v-7bfd41f8>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/allnews" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="more_news__btn" data-v-7bfd41f8${_scopeId}>\u0412\u0441\u0435 \u043D\u043E\u0432\u043E\u0441\u0442\u0438</button>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7bfd41f8"]]);
...
//# sourceMappingURL=index-Cun9IMBg.mjs.map
